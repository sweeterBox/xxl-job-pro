...
public class SampleXxlJob {
     ...
     * 2、分片广播任务
     */
    @ScheduledTask(value = "shardingJobHandler",description = "分片广播任务")
     ...
     * 3、命令行任务
     */
    @ScheduledTask(value = "commandJobHandler",description = "命令行任务")
     ...
     */
    @ScheduledTask(value = "demoJobHandler2", init = "init", destroy = "destroy")
