...
import com.xxl.job.client.executor.RegistryConfig;
...
import com.xxl.job.client.utils.FileUtil;
import com.xxl.job.client.utils.JdkSerializeTool;
...
public class TriggerCallbackThread {
    ...
    private static Logger log = LoggerFactory.getLogger(TriggerCallbackThread.class);
    ...
    public static void pushCallBack(HandleCallbackParam callback){
        ...
        log.info(" xxl-job, push callback request, logId:{}", callback.getLogId());
    }
...
/*        // retry
    ...
    private void doCallback(List<HandleCallbackParam> callbackParamList){
        ...
        for (AdminApiClient adminBiz: XxlJobExecutor.getAdminBizList()) {
            try {
                R<String> callbackResult = adminBiz.callback(callbackParamList);
                if (callbackResult!=null && R.SUCCESS_CODE == callbackResult.getCode()) {
    ...
    private void callbackLog(List<HandleCallbackParam> callbackParamList, String logContent){
        for (HandleCallbackParam callbackParam: callbackParamList) {
            String logFileName = XxlJobFileAppender.makeLogFileName(new Date(callbackParam.getTimestamp()), callbackParam.getLogId());
